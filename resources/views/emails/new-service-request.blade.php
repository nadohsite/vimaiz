...
@section('content')
    ...
    <div class="success-box">
        ...
        <p><strong>Date souhaitée :</strong> {{ optional($serviceRequest->scheduled_date)->format('d/m/Y') ?? 'Flexible' }}</p>
    </div>
    ...
    <p>Merci de traiter cette demande rapidement pour maintenir un bon niveau de service.</p>
