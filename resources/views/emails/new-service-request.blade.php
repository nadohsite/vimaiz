...
@section('title', 'Nouvelle demande de ménage')

@section('content')
    <h1>🏠 Nouvelle demande de ménage</h1>
    
    <p>Bonjour {{ $notifiable->name }},</p>
    
    <p>Une nouvelle demande de ménage a été soumise et attend votre traitement.</p>
    ...
    <div class="info-box">
        ...
        <p><strong>Logement :</strong> {{ $serviceRequest->property->name ?? 'N/A' }} - {{ $serviceRequest->property->city ?? '' }}</p>
